...
\begin{enumerate}
\item Usage:
\texttt{fabia(X,p=5,alpha=0.1,cyc=500,spl=1.0,spz=1.0,random=1.0,center=2,norm=1,scale=0.0,lap=1.0)}
...
\hspace*{6em}\verb+   random=1.0,center=2,norm=1,scale=0.0,lap=1.0)+
...
\item  Usage:
\texttt{fabias(X,p=5,alpha=0.6,cyc=500,spz=1.0,random=1.0,center=2,norm=1,lap=1.0)}
