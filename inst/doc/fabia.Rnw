...
%setwd("c:/sepp/work/fabia/fabia_151/fabia/inst/doc")
%Sweave("fabia.Rnw")
...
\hspace*{6em}\verb+ random=1.0,write_file=1,norm=1,scale=0.0,lap=1.0,nL=0,lL=0,bL=0,+\\
\hspace*{6em}\verb+ samples=0,initL=0,iter=1,quant=0.001)+
